...
//
// - Any necessary authentication data is also provided within the `*types.SpecConfig`
// parameters
//
...
type Provider interface {
	...
	Upload(ctx context.Context, vol types.StorageVolume, target *types.SpecConfig) (*types.SpecConfig, error)
	...
	Download(ctx context.Context, source *types.SpecConfig) (types.StorageVolume, error)
