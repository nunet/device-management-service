...
func TestEmptyValue(t *testing.T) {
	...
	assert.Equal(t, false, IsEmptyValue(types.FreeResources{Vcpu: 1}))
	assert.Equal(t, false, IsEmptyValue(&types.FreeResources{Vcpu: 1}))
}
