...
const (
	...
	DeploymentLogsAsyncBehavior       = "/dms/node/deployment/logs/async"
	DeploymentLogsAsyncStatusBehavior = "/dms/node/deployment/logs/async/status"
	DeploymentLogsAsyncStopBehavior   = "/dms/node/deployment/logs/async/stop"
