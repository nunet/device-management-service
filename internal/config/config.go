...
type General struct {
	...
	StorageBricks          []string `mapstructure:"storage_bricks" json:"storage_bricks"`
	StorageReplicaCount    int      `mapstructure:"storage_replica_count" json:"storage_replica_count"`
}
