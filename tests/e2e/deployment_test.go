...
// DeploymentRestorationFromCommittingTaskAllocation tests restoration when crash occurs at Committing using a TASK allocation
func DeploymentRestorationFromCommittingTaskAllocation(suite *TestSuite) {
	suite.Run("DeploymentRestorationFromCommitting_TaskAllocation", func() {
		suite.Require().Len(suite.nodes, 3)
		deployer := suite.nodes[1]
...
// DeploymentRestorationFromProvisioningTaskAllocation tests restoration when crash occurs at Provisioning using a TASK allocation
func DeploymentRestorationFromProvisioningTaskAllocation(suite *TestSuite) {
	suite.Run("DeploymentRestorationFromProvisioning_TaskAllocation", func() {
		suite.Require().Len(suite.nodes, 3)
		deployer := suite.nodes[1]
