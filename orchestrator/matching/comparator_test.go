...
func TestExecutionResourcesComparator(t *testing.T) {
	...
	executionResources1 := models.ExecutionResources{ CPU: float64(cpu1), 
														Memory: uint64(memory1), 
														Disk: uint64(disk1), 
														GPUs: []models.GPU{gpu1, gpu2},
													}
	executionResources2 := models.ExecutionResources{ CPU: float64(cpu2),
														Memory: uint64(memory2),
														Disk: uint64(disk2),
														GPUs: []models.GPU{gpu1},
													}
	executionResources3 := models.ExecutionResources{ CPU: float64(cpu2),
														Memory: uint64(memory1),
														Disk: uint64(disk2),
